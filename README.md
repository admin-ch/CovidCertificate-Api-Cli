...
swiss-admin-covid-certificate-api-cli/1.2.3 darwin-x64 node-v14.17.0
$ cc-cli --help [COMMAND]
USAGE
  $ cc-cli COMMAND
...
...
_See code: [src/commands/create-recovery.ts](https://github.com/admin-ch/CovidCertificate-Api-Cli/blob/v1.2.3/src/commands/create-recovery.ts)_
...
_See code: [src/commands/create-test.ts](https://github.com/admin-ch/CovidCertificate-Api-Cli/blob/v1.2.3/src/commands/create-test.ts)_
...
_See code: [src/commands/create-vaccination.ts](https://github.com/admin-ch/CovidCertificate-Api-Cli/blob/v1.2.3/src/commands/create-vaccination.ts)_
...
_See code: [src/commands/pm-update.ts](https://github.com/admin-ch/CovidCertificate-Api-Cli/blob/v1.2.3/src/commands/pm-update.ts)_
...
_See code: [src/commands/sign.ts](https://github.com/admin-ch/CovidCertificate-Api-Cli/blob/v1.2.3/src/commands/sign.ts)_
<!-- commandsstop -->
