...
swiss-admin-covid-certificate-api-cli/0.1.2 darwin-x64 node-v14.17.0
$ cc-cli --help [COMMAND]
USAGE
  $ cc-cli COMMAND
...
...
_See code: [src/commands/create-recovery.ts](https://github.com/admin-ch/CovidCertificate-Api-Cli/blob/v0.1.2/src/commands/create-recovery.ts)_
...
_See code: [src/commands/sign.ts](https://github.com/admin-ch/CovidCertificate-Api-Cli/blob/v0.1.2/src/commands/sign.ts)_
<!-- commandsstop -->
